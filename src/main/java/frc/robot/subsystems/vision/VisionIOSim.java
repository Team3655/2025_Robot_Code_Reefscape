 ...
 * VisionIOSim
 * 
 * Simulates the outputs of a Vision IO based off of the robots current assumed position. The class returns 
...
public class VisionIOSim implements VisionIO {
    ...
    /**
     * Mimics the effects of poor quality messy data, aka real world data. This is good for testing your 
     ...
     * the current position of the robot if any tags are in view. 
     * 
     * @param pose A transform representing the relative position of the camera to the center of the robot.
    ...
    public void updateInputs(VisionIOInputs inputs, Pose2d robotPose) {
        ...
        for (int i = 0; i < TAGS.size(); i++) {
            ...
            boolean isCurrentValid = 
                ...
                (USE_RANDOM ? 
                    1 >= Math.abs(random.nextGaussian() * ((xyAngle / horizontalFOV.getRadians() * 2))) : true);
