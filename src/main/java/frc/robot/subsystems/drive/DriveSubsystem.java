  ...
  public void periodic() {
    ...
    SmartDashboard.putData("Swerve Drive", new Sendable() {
      ...
      public void initSendable(SendableBuilder builder) {
        ...
        builder.addDoubleProperty("Front Right Velocity", () -> modules[1].getAngle().getRadians(), null);
        ...
        builder.addDoubleProperty("Back Right Velocity", () -> modules[3].getAngle().getRadians(), null);
