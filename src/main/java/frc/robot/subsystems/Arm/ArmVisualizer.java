  ...
  public ArmVisualizer(String key) {
    ...
    switch (key) {
      case "current":
        ...
        elbow = shoulder.append(
            new LoggedMechanismLigament2d("Elbow", ArmConstants.ELBOW_LENGTH_METERS, 0, 4, new Color8Bit(Color.kBlue)));
        wrist = elbow.append(new LoggedMechanismLigament2d("Wrist", ArmConstants.WRIST_LENGTH_METERS, 0, 2,
      ...
      case "setpoint":
        ...
        elbow = shoulder.append(new LoggedMechanismLigament2d("Elbow", ArmConstants.ELBOW_LENGTH_METERS, 90, 4,
            new Color8Bit(Color.kYellow)));
